...
const Hero = () => {
  return (
    <section className="min-h-[87vh] flex items-center overflow-x-hidden relative">
      <div className="lg:container h-full mx-auto  px-4 sm:px-6 lg:px-8 md:py-24 md:lg:py-24 lg:max-w-[1440px] bg-slate-800 rounded-[2rem]">
          ...
          <div className=" md:w-1/2 p-6 grid place-items-center">
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="relative space-x-6">
                <Link
                  href="/waitlist"
                  className="bg-amber-500 text-white inline-block py-4 px-10 rounded-2xl"
                >
                  Join Waitlist
                </Link>
              </div>
